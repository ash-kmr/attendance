...
class MediterranesnDietView extends StatefulWidget {
  ...
  State<StatefulWidget> createState() {
    ...
    return _StateMediterranesnDietView();
  }
}

class _StateMediterranesnDietView extends State<MediterranesnDietView> with TickerProviderStateMixin {
  ...
  void initState() {
    ...
    animation = Tween(begin: 1.0, end: 1.0).animate(CurvedAnimation(
